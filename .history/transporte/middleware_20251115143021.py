...
class PermisosMiddleware:
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        # Si la URL actual es una de las problemáticas, mostrar info extra
        urls_problematicas = ['conductor_crear', 'piloto_crear', 'cliente_crear', 'carga_crear', 'seguro_crear']
        if request.resolver_match.url_name in urls_problematicas:
            print("🚨 URL PROBLEMÁTICA DETECTADA!")
