...
/', views.api_view, name='api'),  # COMENTADA O ELIMINADA
    ...
    # PDF
    path('reportesrouter = DefaultRouter()
...
urlpatterns = [
    ...
    path('api-docs/generar-pdf/', views.generar_reporte_pdf, name='generar_reporte_pdf'),
