...
urlpatterns = [
    ...
    # URLs de edición (solo admin) - AGREGAR LAS QUE FALTAN
    path('vehiculos/<int:pk>/editar/', admin_required(views.editar_vehiculo), name='vehiculo_editar'),
    path('vehiculos/crear/', admin_required(views.crear_vehiculo), name='vehiculo_crear'),  # NUEVA URL
    path('vehiculos/<int:pk>/eliminar/', admin_required(views.eliminar_vehiculo), name='vehiculo_eliminar'),  # NUEVA URL
    
    path('aeronaves/<int:pk>/editar/', admin_required(views.editar_aeronave), name='aeronave_editar'),
    path('aeronaves/crear/', admin_required(views.crear_aeronave), name='aeronave_crear'),  # NUEVA URL
    ...
    path('conductores/crear/', admin_required(views.crear_conductor), name='conductor_crear'),  # NUEVA URL
    path('conductores/<int:pk>/eliminar/', admin_required(views.eliminar_conductor), name='conductor_eliminar'),  # NUEVA URL
    
    path('pilotos/<int:pk>/editar/', admin_required(views.editar_piloto), name='piloto_editar'),
    path('pilotos/crear/', admin_required(views.crear_piloto), name='piloto_crear'),  # NUEVA URL
    path('pilotos/<int:pk>/eliminar/', admin_required(views.eliminar_piloto), name='piloto_eliminar'),  # NUEVA URL
    
    path('clientes/<int:pk>/editar/', admin_required(views.editar_cliente), name='cliente_editar'),
    path('clientes/crear/', admin_required(views.crear_cliente), name='cliente_crear'),  # NUEVA URL
    path('clientes/<int:pk>/eliminar/', admin_required(views.eliminar_cliente), name='cliente_eliminar'),  # NUEVA URL
    
    path('cargas/<int:pk>/editar/', admin_required(views.editar_carga), name='carga_editar'),
    path('cargas/crear/', admin_required(views.crear_carga), name='carga_crear'),  # NUEVA URL
    path('cargas/<int:pk>/eliminar/', admin_required(views.eliminar_carga), name='carga_eliminar'),  # NUEVA URL
    
    path('seguros/<int:pk>/editar/', admin_required(views.editar_seguro), name='seguro_editar'),
    path('seguros/crear/', admin_required(views.crear_seguro), name='seguro_crear'),  # NUEVA URL
    path('seguros/<int:pk>/eliminar/', admin_required(views.eliminar_seguro), name='seguro_eliminar'),  # NUEVA URL

  ('api/v1/rutas/', api_rutas_list, name='api_rutas_list'),
