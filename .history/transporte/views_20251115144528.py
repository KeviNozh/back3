...
def crear_vehiculo(request):
    ...
    print("🔍 CREAR_VEHICULO - Iniciando...")
    print(f"   Método: {request.method}")
    print(f"   Usuario: {request.user}")
    
    if request.method == 'POST':
        print("🔍 CREAR_VEHICULO - Procesando POST...")
        try:
            # Obtener datos del formulario
            ...
            print("🔍 CREAR_VEHICULO - ¡Vehículo creado exitosamente!")
            messages.success(request, 'Vehículo creado exitosamente')
            return redirect('vehiculos')
            
        except Exception as e:
            print(f"🔍 CREAR_VEHICULO - Error: {str(e)}")
